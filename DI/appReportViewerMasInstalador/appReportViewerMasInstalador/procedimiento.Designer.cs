...
namespace appReportViewerMasInstalador {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CLIENTESDataTable : global::System.Data.TypedTableBase<CLIENTESRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CLIENTESRow AddCLIENTESRow(string NOMBRES, string APELLIDOS, string RUC, string TELEFONO, string DIRECCION) {
        ...
        public partial class CLIENTESRow : global::System.Data.DataRow {
            ...
            public string RUC {
                get {
                    try {
                        return ((string)(this[this.tableCLIENTES.RUCColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace appReportViewerMasInstalador.DataSet1TableAdapters {
    ...
    public partial class CLIENTESTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [clientes] WHERE (([ID] = @Original_ID) AND ((@IsNull_NOMBRES = 1 AND [NOMBRES] IS NULL) OR ([NOMBRES] = @Original_NOMBRES)) AND ((@IsNull_APELLIDOS = 1 AND [APELLIDOS] IS NULL) OR ([APELLIDOS] = @Original_APELLIDOS)) AND ((@IsNull_RUC = 1 AND [RUC] IS NULL) OR ([RUC] = @Original_RUC)) AND ((@IsNull_TELEFONO = 1 AND [TELEFONO] IS NULL) OR ([TELEFONO] = @Original_TELEFONO)) AND ((@IsNull_DIRECCION = 1 AND [DIRECCION] IS NULL) OR ([DIRECCION] = @Original_DIRECCION)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [clientes] ([NOMBRES], [APELLIDOS], [RUC], [TELEFONO], [DIRECCION]) V" +
                "ALUES (@NOMBRES, @APELLIDOS, @RUC, @TELEFONO, @DIRECCION);\r\nSELECT ID, NOMBRES, " +
                "APELLIDOS, RUC, TELEFONO, DIRECCION FROM CLIENTES WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [clientes] SET [NOMBRES] = @NOMBRES, [APELLIDOS] = @APELLIDOS, [RUC] = @RUC, [TELEFONO] = @TELEFONO, [DIRECCION] = @DIRECCION WHERE (([ID] = @Original_ID) AND ((@IsNull_NOMBRES = 1 AND [NOMBRES] IS NULL) OR ([NOMBRES] = @Original_NOMBRES)) AND ((@IsNull_APELLIDOS = 1 AND [APELLIDOS] IS NULL) OR ([APELLIDOS] = @Original_APELLIDOS)) AND ((@IsNull_RUC = 1 AND [RUC] IS NULL) OR ([RUC] = @Original_RUC)) AND ((@IsNull_TELEFONO = 1 AND [TELEFONO] IS NULL) OR ([TELEFONO] = @Original_TELEFONO)) AND ((@IsNull_DIRECCION = 1 AND [DIRECCION] IS NULL) OR ([DIRECCION] = @Original_DIRECCION)));
SELECT ID, NOMBRES, APELLIDOS, RUC, TELEFONO, DIRECCION FROM CLIENTES WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::appReportViewerMasInstalador.Properties.Settings.Default.DASHBOARDConnectionString1;
        }
        ...
        public virtual int Delete(int Original_ID, string Original_NOMBRES, string Original_APELLIDOS, string Original_RUC, string Original_TELEFONO, string Original_DIRECCION) {
            ...
            if ((Original_RUC == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_RUC));
            }
        ...
        public virtual int Insert(string NOMBRES, string APELLIDOS, string RUC, string TELEFONO, string DIRECCION) {
            if ((NOMBRES == null)) {
        ...
        public virtual int Update(string NOMBRES, string APELLIDOS, string RUC, string TELEFONO, string DIRECCION, int Original_ID, string Original_NOMBRES, string Original_APELLIDOS, string Original_RUC, string Original_TELEFONO, string Original_DIRECCION, int ID) {
            if ((NOMBRES == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NOMBRES, string APELLIDOS, string RUC, string TELEFONO, string DIRECCION, int Original_ID, string Original_NOMBRES, string Original_APELLIDOS, string Original_RUC, string Original_TELEFONO, string Original_DIRECCION) {
            return this.Update(NOMBRES, APELLIDOS, RUC, TELEFONO, DIRECCION, Original_ID, Original_NOMBRES, Original_APELLIDOS, Original_RUC, Original_TELEFONO, Original_DIRECCION, Original_ID);
        }
    }
