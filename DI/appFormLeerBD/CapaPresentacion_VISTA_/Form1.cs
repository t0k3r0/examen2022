...
namespace CapaPresentacion_VISTA_
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection Conexion = new SqlConnection("Server=localhost\\MSSQLSERVER2;Initial Catalog=DASHBOARD;Persist Security Info=false;User ID=di;Password=1234");
        SqlCommand cmd;
        //SqlDataReader dr;
